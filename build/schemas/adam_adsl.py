"""Schema for `adam.adsl`. Producer: `03_derive_adsl`.
...
DTYPES: dict[str, str] = {
    ...
    'SITE_NAME': 'object',  # string, nullable=False, e.g. Toronto General | Boston Medical Ctr | Tokyo Univ Hosp
    'SITE_COUNTRY': 'object',  # string, nullable=False, e.g. CAN | USA | JPN
    'SITE_REGION': 'object',  # string, nullable=False, e.g. NA | NA | APAC
    'SAFFL': 'object',  # string, nullable=False, e.g. Y | Y | Y
    'ITTFL': 'object',  # string, nullable=False, e.g. Y | N | N
}
